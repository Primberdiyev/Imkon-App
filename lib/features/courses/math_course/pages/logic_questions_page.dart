...
class _LogicQuestionsPageState extends State<LogicQuestionsPage> {
  ...
  final List<Map<String, String>> questions = [
    ...
    {
      'question':
          'Bir qutida 10 ta shokolad bor, har kuni 2 tasi yeyiladi. Nechun kun shokoladlar tugaydi?',
      'answer': '5 kun',
    },
    {
      'question':
          '7 ta kitob bor, har birida 10 bet bor. Umumiy nechta bet bor?',
      'answer': '70 bet',
    },
  ];
